                      ...
                      <div className="min-w-[150px]">
                        <div className="flex items-center gap-2">
                          ...
                          {buque.registro_completo === false && (
                            <span className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium bg-orange-100 text-orange-700 rounded-full" title="Registro creado automáticamente - Falta completar datos">
