                    ...
                    <table className="w-full">
                      <thead className="bg-gray-50/50 border-b border-gray-200">
                        <tr>
                          ...
                          <th className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider hidden md:table-cell">Hora Entrada</th>
                          <th className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider hidden md:table-cell">Hora Salida</th>
                          <th className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Entrada</th>
                          <th className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Salida</th>
                          <th className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Depositado</th>
                      ...
                      <tbody>
                        {manifiestos.length === 0 ? (
                          <tr>
                            <td colSpan={10} className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-sm text-gray-700 text-center py-8 text-gray-500">
                          ...
                          manifiestos.map((m) => (
                            <tr key={m.id} className="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                              <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-sm text-gray-700">
                                <span className="font-semibold text-blue-600 whitespace-nowrap">#{m.id}</span>
                              </td>
                              <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-sm text-gray-700">
                              ...
                              <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-sm text-gray-700 hidden md:table-cell">
                                <span className="text-gray-700 whitespace-nowrap">{m.hora_entrada || '—'}</span>
                              </td>
                              <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-sm text-gray-700 hidden md:table-cell">
                                <span className="text-gray-700 whitespace-nowrap">{m.hora_salida || '—'}</span>
                              </td>
                              <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-sm text-gray-700">
                                <span className="text-gray-900 font-semibold">{m.peso_entrada.toFixed(2)} kg</span>
                              </td>
                              <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-sm text-gray-700">
                                <span className="text-gray-900 font-semibold">{m.peso_salida != null ? `${m.peso_salida.toFixed(2)} kg` : '—'}</span>
                              </td>
                              <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-sm text-gray-700">
                                <span className="font-bold text-blue-600">{Number(m.total_depositado || 0).toFixed(2)} kg</span>
                              </td>
                              ...
                              <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-sm text-gray-700">
                                <div className="flex gap-1 sm:gap-2 min-w-[160px]">
                                  <button
                                    ...
                                    className="px-2 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center gap-1 sm:gap-1.5 font-medium whitespace-nowrap"
                                    title="Descargar PDF"
                                  >
